    ...
    <div class="ltn__utilize-menu-inner ltn__scrollbar">
                ...
                <ul class="list category-select2" id="categoryList2">
                    ...
                    @foreach ($categoriesOrderedByRank as $category)
                        ...
                        <li class="option" data-id="{{ $id }}"
                            onclick="mobsetSearchCategoryId({{ $category->id }}, '{{ $category->name[$locale] }}'); return false;">
        ...
        <div class="ltn__utilize-menu-search-form">
            <form action="{{ url('/products') }}">
                <input type="hidden" id="mobselectedSearchCategoryId" name="mobselectedSearchCategoryId"
                    value="">

                <input type="text" name="mob_search_name" id="mob_search_name" placeholder="Search..." />
        ...
        <div class="ltn__utilize-menu">
            <ul>
                ...
                <li class="special-link shine">
                    <a class="p-0"
                        href="{{ LaravelLocalization::localizeUrl('/distribute') }} ">{{ __('links.distribute') }}</a>
                </li>
            </ul>
        ...
        <div class="ltn__social-media-2">
            <ul>
                <li>
                    <a href="{{ $contactUsFirstRow->facebook ?? '#' }} title="Facebook"><i
                            class="fab fa-facebook-f"></i></a>
                </li>
                <li>
                    <a href="{{ $contactUsFirstRow->twitter ?? '#' }}" title="Twitter"><i
                            class="fab fa-twitter"></i></a>
                </li>

                <li>
                    <a href="{{ $contactUsFirstRow->instagram ?? '#' }}" title="Instagram"><i
...
<div class="mobile-header-menu-fullwidth">
    ...
    <div class="row">
        ...
        <div class="mobile-menu-toggle d-lg-none">
            ...
            </div> <a href="#ltn__utilize-mobile-menu" class="ltn__utilize-toggle">
