...
@section('content')
                                            ...
                                            <div class="slide-item-info-inner ltn__slide-animation row">
                                                <div
                                                    ...
                                                    <div class="btn-wrapper animated">
                                                        <a href="{{ url('product/' . $slider->slug['en']) }}"
                                                            class="theme-btn-1 btn text-uppercase">More
                                                            Details</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="slid-itm-img animated col-7 col-lg-6 ">
                                                    <img src="{{ asset("$slider->main_image") }}" alt=""
                                                        srcset="" />
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="scnd-section ltn__blog-area ltn__blog-item-3-normal mb-70 mt-70">
        {{-- <div class="container-lg"> --}}
            <!-- row  -->
            <div class="bg-light py-5 service-18">
                <div class="container">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body ml-0 ml-md-3">
                                                <h6 class="font-weight-medium"> {!! $feature->home_title['en'] !!}</h6>
                                                <p> {!! $feature->featured_text_en !!}</p>
                                                <a href="{{ url('product/' . $feature->slug['en']) }}"
                                                    class="theme-btn-1 btn f-s-11-5">Know More </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col px-lg-0 m-auto text-center text-md-start">
                                    <div class="ltn__product-item ltn__product-item-3 text-left px-2 mx-5 mx-sm-0">
                                        <div class="product-img" style="height: 240px !important">
                                            <a href="{{ url('product/' . $best_selling->slug['en']) }}"><img
                                                    style="height: 100%" src="{{ asset("$best_selling->main_image") }}"
                                                    alt="#" /></a>
                                        </div>
                                        <div class="product-info">
                                            <h2 class="product-title">
                                                <a href="{{ url('product/' . $best_selling->slug['en']) }}"
                                                    class="f-s-13 text-in-blue f-w-r">{{ $best_selling->category->name['en'] ?? '' }}
                                                </a>
                                            </h2>
                                            <div class="product-price">
                                                <span
                                                    class="f-s-16 text-in-dark">{{ strip_tags(\Illuminate\Support\Str::words($best_selling->home_title['en'], 5, '')) }}</span>
                                            </div>
                                        </div>
                                        <a href="{{ url('product/' . $best_selling->slug['en']) }}"
                ...
                <div class="ltn__call-to-action-area ltn__call-to-action-4 pt-20">
                    <div class="call-to-action-inner call-to-action-inner-4 text-center">
                        <div class="section-title-area ltn__section-title-2">
                            <h1 class="section-title white-color d-flex"> <i
                                    class="fab fa-whatsapp px-2 d-block d-sm-none"></i>
                                ...
                                <div class="ltn__category-item ltn__category-item-3 text-center">
                                    ...
                                    <div class="ltn__category-item-name">
                                        <h5>
                                            <a href="{{ url('/products') }}"
                                                onclick="setSearchCategoryId({{ $category->id }}, '{{ $category->name['en'] }}'); return false;"
                                                class="f-s-15 text-in-dark">{{ $category->name['en'] }}</a>
                                        </h5>
                                        <h6 class="f-s-13 text-in-dark">[ {{ $category->products_count }}
                                            item{{ $category->products_count > 1 ? 's' : '' }} ]</h6>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-5 align-self-center justify-content-center">
                            <div class="about-us-img-wrap about-img-left">
                                <img width="100%" src="{{ asset('webasset/img/bg/Group15128(1).png') }}"
                                    alt="About Us Image" />
                            </div>
                        </div>
                        <div class="col-lg-7 row align-content-end p-5">
                            <div class="about-us-info-wrap">
                                <div class="section-title-area ltn__section-title-2">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        <img src="{{ asset('webasset/img/icons/line.png') }}" alt=""
                                            srcset="" style="margin-right: 10px;">
                            ...
                            <div
                                class="about-author-info d-flex flex-wrap justify-content-between  p-xs-5 p-sm-5 p-md-5 p-lg-1">
                                ...
                                <div class="author-sign align-self-center mt-3">
                                    <a href="{{ $about->company_katalog }}" download=""
                                        class="special-link-products shine">Download Katalog</a>
                                </div>
                            </div>
                        </div>
                    </div>
