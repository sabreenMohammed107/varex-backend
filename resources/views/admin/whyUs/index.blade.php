            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <!--begin::Add product-->
                        <a href="{{ route('admin.why-us.create') }}" class="btn btn-primary">Add Media</a>
                        <!--end::Add product-->
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-50px">
                                                <span class="symbol-label" style="background-image: url('{{ asset("$row->icon") }}');"></span>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <a href="#"
                                                    ...
                                                    >
                                                    {{ $row->created_at ? $row->created_at->format('Y-m-d') : '' }}</a>
                                                <!--end::Title-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.why-us.edit', $row->id) }}"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('admin.why-us.destroy', $row->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
