    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Tags</h1>
                <!--end::Title-->
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_new_image">Add Tag</a>
                        <!--end::Add Image-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_gallery_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">Tag Name</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach ($tags as $index => $tag)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a data-bs-toggle="modal" data-bs-target="#kt_modal_edit_image_{{ $tag->id }}" class="dropdown-item">Edit</a>
                                            <a href="#" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('delete_tag_{{ $tag->id }}').submit();">Delete</a>
                                            <form id="delete_tag_{{ $tag->id }}" action="{{ route('admin.tags.destroy',$tag->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
                                ...
                                <div class="modal fade" id="kt_modal_edit_image_{{ $tag->id }}" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
    ...
    <div class="modal fade" id="kt_modal_new_image" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_image_form" class="form" method="POST" action="{{ route('admin.tags.store') }}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <h1 class="mb-3">Add New Tag</h1>
                        </div>
                        <!--end::Heading-->
                        <div class="mb-10 fv-row">
                            <label class="required form-label">Title En</label>
