...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            ...
            action="{{ route('admin.faqs.update', $faq->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                <!--begin::Main column-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="question_ar" class="form-control mb-2"
                                    placeholder="Question in Arabic" value="{{ $faq->question['ar'] }}" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="question_en" class="form-control mb-2"
                                    placeholder="Question in English" value="{{ $faq->question['en'] }}" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Textarea-->
                                <textarea name="answer_ar" class="form-control mb-2" placeholder="Answer in Arabic" required>{{ $faq->answer['ar'] }}</textarea>
                                <!--end::Textarea-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Textarea-->
                                <textarea name="answer_en" class="form-control mb-2" placeholder="Answer in English" required>{{ $faq->answer['en'] }}</textarea>
                                <!--end::Textarea-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="active" value="1"
                                        id="flexSwitchDefault" @if($faq->active == 1) checked @endif />
