                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px">En question</th>
                                <th class="min-w-200px">Ar question</th>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-kt-ecommerce-category-filter="category_name">  {{ $row->question['en'] }}</a>
                                                <!--end::Title-->
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('admin.faqs.destroy', $row->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
