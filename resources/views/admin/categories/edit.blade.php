                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name_ar" class="form-control mb-2"
                                    placeholder="Category name in Arabic" value="{{ $category->name['ar'] }}"
                                    required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name_en" class="form-control mb-2"
                                    placeholder="Category name in English" value="{{ $category->name['en'] }}"
                                    required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="rank" class="form-control mb-2" placeholder="Category rank"
                                    value="{{ $category->rank }}" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
