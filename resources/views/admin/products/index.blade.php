                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-50px">
                                                <span class="symbol-label" style="background-image: url('{{ asset("$row->main_image") }}');"></span>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <!--end::Menu item-->
                                             <!--begin::Menu item-->
                                             <div class="menu-item px-3">
                                                <a href="{{ route('admin.products.gallery', $row->id) }}"
                                                    class="menu-link px-3">Gallery</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{$row->id}}"
                                                    action="{{ route('admin.products.destroy', $row->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
